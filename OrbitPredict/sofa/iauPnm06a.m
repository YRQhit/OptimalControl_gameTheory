...
% 
%   Reference:
%      RF1：Capitaine, N. & Wallace, P.T., 2006, Astron.Astrophys. 450, 855.
%      RF2：刘林，参考坐标系及航天应用.
...
%RF1,公式(4)            RF2，公式(3.38)
[gamb, phib, psib, epsa] = iauPfw06(date1, date2);      
%
% Nutation components    RF2，公式(3.12)
[dp, de] = iauNut06a(date1, date2);    %对应matlab自带的函数322行nutationAngles

% Equinox based nutation x precession x bias matrix
rnpb = iauFw2m(gamb, phib, psib + dp, epsa + de);   %RF，公式3.40   3.41，符号？
