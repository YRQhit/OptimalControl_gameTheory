...
Impulse2Thrust_overview.html - HTML overview documentation file for the generated 
                               component. It contains the requirements for accessing the 
                               component and for generating arguments using the MWArray 
                               class hierarchy.

Impulse2Thrust.xml - This file contains the code comments for the Impulse2Thrust 
                               ...
                               documentation for the Impulse2Thrust component.
