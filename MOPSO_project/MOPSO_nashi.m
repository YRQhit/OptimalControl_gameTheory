...
function delta_velocity = MOPSO_nashi(time)
global decide_time_binary;
decide_time_binary = time;
% 设置参数
...
global red_max_push;
    ...
    for i = 1:numParticles
        position1 = randn(1,3);%red
        position2 = randn(1,3);%blue
        
        if norm(position1) > blue_max_push
...
%         particles(i).velocity = w * particles(i).velocity;
        ...
        position1 = particles(i).position(1:3);%red
